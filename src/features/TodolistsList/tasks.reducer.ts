import {ResultCode, TaskPriorities, TaskStatuses, TaskType, todolistsAPI, UpdateTaskModelType} from "common/api/todolists-api";
...
const addTask = createAsyncThunk<{ task: TaskType }, {
    todolistId: string,
    taskTitle: string
}>("tasks/addTaskTC", async (arg, thunkAPI) => {
    const {dispatch, rejectWithValue} = thunkAPI;
    const taskTitle = arg.taskTitle;
    try {
...
const updateTask = createAsyncThunk<UpdateTaskArgType, UpdateTaskArgType>
...
// каждую санку ложим в объект и exporting...
